...
export default class App extends React.Component {
  ...
  drawItem = itemNumber => {
    if (this.state.winMessage === "") {
      ...
      Alert.alert("Message:", "Now You Can not Play More...!!!", [
        {
          text: "OK",
  ...
  winGame = () => {
    ...
    if (
      ...
      // this.showAlert(this.state.winMessage);
    } else if (
      itemArray[3] !== "empty" &&
      ...
      this.setState({
        winMessage: "No One Win..!!!"
      });
    }
  };

  showAlert = value => {
    Alert.alert("Alert Title", value, [
      {
        text: "OK",
        onPress: () => this.resetGame(),
        style: "cancel"
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.watermark}>-Saloni Darji</Text>
      </View>
    );
  }
}
